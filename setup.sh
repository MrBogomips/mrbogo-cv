...
echo ""
echo "Build commands:"
echo "  typst compile --font-path ./fonts --input lang=en cv.typ output/cv-en.pdf"
echo "  typst compile --font-path ./fonts --input lang=it cv.typ output/cv-it.pdf"
echo ""
echo "Watch mode (auto-rebuild):"
echo "  typst watch --font-path ./fonts --input lang=en cv.typ output/cv-en.pdf"
