...
// Usage: typst compile --input lang=en --input letter=default letter.typ output.pdf

#let lang = sys.inputs.at("lang", default: "en")
#let letter-file = sys.inputs.at("letter", default: "default")

#import "templates/letter.typ": *
